...
class UserSharedPreferences {
  ...
  static Future<void> setToDoList(List<ToDoModel> todoList) async {
    final String todoJson = jsonEncode(todoList.map((ToDoModel e) => e.toJson()).toList());
  ...
  static List<ToDoModel> getToDoList() {
    ...
    if (todoJson != null) {
      return (jsonDecode(todoJson) as List<dynamic>).map((dynamic e) => ToDoModel.fromJson(e)).toList();
    }
    return <ToDoModel>[];
  }
