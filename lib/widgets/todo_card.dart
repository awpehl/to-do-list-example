                ...
                children: <Widget>[
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      ...
                      ToDoTime(label: "Time Left", startDate: startDate, endDate: endDate, showTimer: true, time: ''),
                    ],
                  ),
                ],
              ),
        ...
        if (showTimer)
          CountdownTimer(
            ...
            widgetBuilder: (BuildContext context, CurrentRemainingTime? time) {
              ...
              String min = days.isEmpty && time?.min != null ? '${time?.min} min ' : '';
              String sec = days.isEmpty && hours.isEmpty && time?.sec != null ? '${time?.sec} sec' : '';
              if (time == null) {
                return const Text('-');
              }
              return Text(
